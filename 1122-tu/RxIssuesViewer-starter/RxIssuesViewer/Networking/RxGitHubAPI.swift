...
class RxGitHubAPI {
	...
	static private let clientID = "1deaf4a3fa89727b0b01"
	static private let clientSecret = "1214cea723d444bf5a91ad5fab01601a0080b7fa"
					...
					if let data = data, let string = NSString(data: data, encoding: String.Encoding.utf8.rawValue) as? String {
						...
						if let accessToken = accessToken {
							...
							DispatchQueue.main.async {
								...
								let vc = storyboard.instantiateViewController(withIdentifier: "searchRepoVC")
